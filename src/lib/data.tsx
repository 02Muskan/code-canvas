...
export const projects = [
  {
    ...
    description: "A slick, responsive e-commerce frontend with dynamic filtering, a shopping cart, and a smooth checkout experience.",
    tags: ["Next.js", "React", "State Management", "Tailwind CSS"],
  ...
  },
  {
    ...
    description: "A Kanban-style task management app with drag-and-drop functionality and a focus on collaborative UI.",
    tags: ["React", "TypeScript", "Frontend-only"],
    image: "https://placehold.co/600x400.png",
    aiHint: "to-do list",
    github: "https://github.com",
    live: "https://example.com",
  },
  {
    ...
    description: "My personal portfolio to showcase my skills and projects, built with performance and design in mind.",
  ...
  },
  {
    ...
    description: "A clean, modern weather application that fetches and displays data from the OpenWeatherMap API.",
  ...
  },
  {
    ...
    description: "A fast, SEO-friendly blog frontend powered by a headless CMS like Contentful or Sanity.",
  ...
  },
  {
    ...
    description: "An interactive dashboard for visualizing complex data sets using Recharts and React.",
    tags: ["React", "Recharts", "Data Vis"],
    image: "https://placehold.co/600x400.png",
