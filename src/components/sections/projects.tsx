  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back Side */}
        <div className="absolute inset-0 h-full w-full rounded-lg bg-secondary text-center text-slate-200 [transform:rotateY(180deg)] [backface-visibility:hidden]">
              ...
              <div className="flex justify-center gap-2 pt-4">
                {project.github && (
                  <Button variant="ghost" size="icon" asChild>
                    <a href={project.github} target="_blank" rel="noopener noreferrer" aria-label={`${project.title} GitHub`} onClick={(e) => e.stopPropagation()}>
                ...
                {project.live && (
                  <Button variant="ghost" size="icon" asChild>
                    <a href={project.live} target="_blank" rel="noopener noreferrer" aria-label={`${project.title} live demo`} onClick={(e) => e.stopPropagation()}>
